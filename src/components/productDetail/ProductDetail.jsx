...
import { findChampionProductsByRegion, findChibiProductsByChampion, findProductsById, findSkinProductsBySeries } from '../../state/product/Action';
                                                            ...
                                                            <>
                                                                <RadioGroup.Label>
                                                                    ...
                                                                    <img
                                                                        ...
                                                                        alt=""
                                                                    />
                                                                    <p className={`text-gray-300 justify-center flex ${item.name === "Default" && 'mt-11'}`}>
                                                                        {item.name}
                                                                    </p>
                                                                    <p className='text-gray-300 justify-center flex pt-3'>
